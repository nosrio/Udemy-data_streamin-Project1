...
class Producer:
    ...
    def __init__(
        ...
        self.producer = AvroProducer({"bootstrap.servers" : self.broker_properties['kafka_url']},
    ...
    def create_topic(self):
        ...
        #
        #
        client = AdminClient({"bootstrap.servers": self.broker_properties['kafka_url']})
...
#        logger.info("topic creation kafka integration incomplete - skipping")
    ...
    def close(self):
        ...
        #
        self.producer.flush()
        #logger.info("flushing producer pending messages")
